...
Revision ID: ae10df7724ab
Revises: 
Create Date: 2026-02-15 18:27:57.718186
...
def upgrade() -> None:
    ...
    sa.Column('room_type', sa.Enum('luxury', 'junior_suite', 'Family', 'Economy', 'Single', name='roomtypechoices'), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['hotel_id'], ['hotel.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
